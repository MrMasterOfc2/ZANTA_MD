...
const dares = [
    "ඔබේ Profile Picture එක විනාඩි 10ක් මම එවන එක දාගන්න.",
    "මෙම Group එකේ සිටින කෙනෙකුට Funny Voice Note එකක් යවන්න.",
    "ගෘප් එකේ සිටින අනිත් අයට විහිළු කතාවක් කියන්න.",
    "ඔබේ ප්‍රියතම ගීතයේ ගායනය හැකිතාක් හයියෙන් හඬ සටහනකින් ගායනා කරන්න.",
    "ඉමෝජි පමණක් භාවිතා කරමින් ඔබගේ ඊළඟ පණිවිඩ 5 ටයිප් කරන්න (වචන නැත).",
    "ඔබේ සම්බන්ධතා ලැයිස්තුවේ අහඹු පුද්ගලයෙකුට කතා කර ඔබ පීසා එකක් ඇණවුම් කරන බව මවාපාන්න.",
    "යාලුවෙකුගේ (Group එකේ නැති) WhatsApp Status 5කට විහිලු Reply යවන්න.",
    "කණ්ඩායමේ පුද්ගලයින් තිදෙනෙකු සඳහන් කර ඔවුන්ට අද්විතීය ආකාරයකින් ප්‍රශංසා කරන්න.",
